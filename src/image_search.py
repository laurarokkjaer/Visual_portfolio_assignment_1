...
# Making a loop that goes through each image in all_images, reading it as an image, calculating its histogram and normalising it 
    ...
    columns = ["1. Similar1", "2. Similar", "3. Similar3", "Target Image"]
...
# Results: the three images that are most similar på the target image (both the distance score and the path belonging to the given image 